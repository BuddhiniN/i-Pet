...
<body>
	<%
        ...
        %>
	<header>
            <a href="index.jsp" style="text-decoration: none; color: greenyellow"><div>
     <i class="fa fa-paw" aria-hidden="true"></i>

      <p style="color: yellow; font-size: 16pt">iPet</p>
                </div></a>
    <nav>
      <ul>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(C:\Users\DELL\Desktop\Ipet\iPET\iPET\web\public\assets\images;)">
