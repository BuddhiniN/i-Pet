...
<body >
   ...
   <link href="public/assets/css/allevent.css" rel="stylesheet" type="text/css"/>
   <a style="text-decoration: none; color: greenyellow" href="index.jsp" ><div>
   ...
   <nav  style="display:<%=hide%>">
    ...
    <h1> Events</h1>
    <p>Cause for Paws Spay it forward.</p>
  </section>
    <div class="container">
        <div class="row">
                <!-- Bootstrap card -->
        ...
        while(rs.next()){
            ...
            <div class="col-4-lg">
                <div class="card" style="width: 20rem; height: 31rem;">
                    <img src="public/data/events/<%=Thumb%>" height="225px" alt="Card One" class="card-img-top">
                    <div class="card-body">
